...
?>
<?php
$enviar = enviarMail($para, $asunto, $mensaje, $email);
if ($enviar) {
?>
  <script>
      ...
      <div class="row">
        ...
        <div class="col-lg-7 col-md-8">
          <div class="contact-form">
            <form class="form" id="contact-form" method="post" action="enviar.php" data-toggle="validator">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      <input id="form_name" type="text" name="name" placeholder="Nombre *" required data-error="Nombre requerido." />
